    ...
    <div class="flex">
        <div class="flex-1">
            <div class="container">
                ...
                <div>
                    <svg viewBox="0 0 1413 584" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="Wayfinder">
                            <g id="Blueprint">
                                <g id="Rooms">
                                    <rect
        ...
        <div class="basis-96 pr-20">
            <div>
                <h3 class="mb-8 border-b-2 pb-2">Schedules</h3>
                <div>
                    {#if !roomEvents}
                        <p class="mb-4">Click a room to show an event.</p>
                    {:else}
                        <h4 class="mb-4">{roomEvents.name}</h4>
